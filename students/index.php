...
<?php
    ...
    $e = $_SESSION['email'];
    $get_students = mysqli_query($conn, "SELECT * FROM students WHERE email='$e'");
    while ($students = mysqli_fetch_object($get_students)) {
...
<title><?php echo $id_number; ?></title>
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between bg-dark text-light">
                    <a href="index.php" class="text-nowrap logo-img">
                        ...
                        <h5 class="text-light">Student Page</h5>
                    </a>
                                ...
                                <form action="process.php" method="POST">
                                    <table class="table mt-3">
                                        ...
                                        <tbody>
                                            ...
                                            $get_student = mysqli_query($conn, "SELECT * FROM clea WHERE id_number = '$id_number' ");
