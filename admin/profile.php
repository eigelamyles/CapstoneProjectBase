                                ...
                                <div class="row">
                                    <div class="col-6 ">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="fn" value="<?php echo $fullname; ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-6 ">
                                        <div class="input-group mb-3">
                                            <div class="input-group-text"><i class="bi bi-person"></i></div>
                                            <input type="text" name="contact" value="<?php echo $phone; ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-6 ">
                                        <div class="input-group mb-3">
                                            <div class="input-group-text"><i class="bi bi-person"></i></div>
                                            <input type="text" name="email" readonly value="<?php echo $e; ?>" class="form-control">
                                        </div> 
                                    ...
                                    <div class="col-12 ">
                                        <div class="input-group mb-3">
                                            <div class="input-group-text"><i class="bi bi-person"></i></div>
                                            <input type="password" name="password" id="pass" value="<?php echo $password; ?>" class="form-control">
                                        </div>
                                        <input type="checkbox" onclick="showpass()">Showpassword
                                        
                                    </div>
                                    <input type="submit" name="upd_profile" class="btn btn-primary" value="Save Changes">
                                    <script>
                                        function showpass(){
