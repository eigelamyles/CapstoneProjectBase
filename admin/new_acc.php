                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-border ">
                            ...
                            <tbody>
                                <?php 
                                 $get_new = mysqli_query($conn,"SELECT * FROM students WHERE account_status = 'New'");
                                ...
                                <tr>
                                    ...
                                    <td><form action="process.php?id=<?php echo $new['id']; ?>&&id_number=<?php echo $new['id_number']; ?>" method="POST">
